...
@Component({
  ...
  styleUrls: ['./game-provider.component.css']
})
export class GSGameProviderComponent implements OnInit {
...
constructor(private storage: LocalStorageService, private spinner: NgxSpinnerService, private http: HttpClient, private dto: DtoService,
  ...
  search() {
    ...
    this.gameList = [];
    this.http.get(this.funct.ipaddress + 'gameProvider/getGameListByParams', {params: params,headers: headers })
    .pipe(
