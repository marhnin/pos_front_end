...
@Component({
  ...
  templateUrl: './sale-promoter-detail.component.html',
  styleUrls: ['./sale-promoter-detail.component.css']
})
export class SalePromoterDetailComponent implements OnInit {
    ...
    .subscribe(
      result => {
        ...
        if (this.dto.Response.status == 'Success') {
          this.spinner.hide();
          this.router.navigate(['/sale-promoter-list']).then(() => {
