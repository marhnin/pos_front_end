...
@Component({
  selector: 'app-point-promotion-users',
  templateUrl: './point-promotion-users.component.html',
  styleUrls: ['./point-promotion-users.component.css']
})
export class PointPromotionUsersComponent implements OnInit {
      ...
      .subscribe(
        result => {
          ...
          if (this.dto.Response.status == 'Success') {
            this.spinner.hide();
            this.router.navigate(['/point-promotion-users']).then(() => {
  ...
  search(){
    ...
    .subscribe(  
      result => {
        ...
        this.dto.Response = result;
        this.userList = this.dto.Response;
        console.log("User list is >>>"+JSON.stringify(this.userList))
        this.page =  0
        this.dtTrigger.next();
        this.spinner.hide();
